...
describe('functions', () => {
    describe('syntax for creating them', () => {
        it('declaring them', () => {
            ...
            // Anonymous Functions
            // -- an anonymous function that is invoked immediately
    ...
    describe('higher order functions', () => {
        ...
        it('first example', () => {
            const answer = formatName("kevin", "downey", makeItUpper);
            expect(answer).toBe("DOWNEY, KEVIN");

            const answer2 = formatName("kevin", "downey", (x: string) => `***${x}***`);
            expect(answer2).toBe(`***downey, kevin***`);

            function makeItUpper(stuff: string) {
    ...
    describe('some lodash goodness', () => {
        it('supports memoization', () => {
            ...
            const memo = _.memoize(doSomething);
